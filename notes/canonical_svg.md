...
6. **Deterministic normalization** — strip comments; collapse insignificant whitespace; sort attributes within an element in a stable order; normalize numeric floats to 3 decimal places; prefer explicit fill/stroke over CSS classes.
...
9. **Coordinates** — all geometry expressed in the root viewBox coordinate system; nested transforms are allowed, though absolute coordinates are preferred.
